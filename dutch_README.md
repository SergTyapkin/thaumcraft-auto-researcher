...
Het programma met behulp van het neurale netwerk ** lost en legt ** onderzoeksnotities in de onderzoekstabel automatisch op en legt op.
...
Het enige dat ze doet is kijken ** pixels op het scherm **, en met behulp van een neuraal netwerk imiteert ** acties met een muis en toetsenbord **, alsof een persoon dat deed.
...
3. ** Na het einde van het uitleggen van de aspecten **, zal een notitie uit de studie in de inventaris worden geplaatst,
...
- [limuranius] (https://github.com/limuranius) voor het creëren van een neuraal netwerk van het bepalen van de aspecten en hun nummer in de tabel, en een groter werk om een ​​lichtgewicht systeem te creëren van het lanceren van neurale netwerken