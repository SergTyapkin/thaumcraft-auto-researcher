...
[![](https://img.shields.io/badge/中文(简体)-_?style=for-the-badge&logo=readme&color=white)](https://github. com/SergTyapkin/thaumcraft-auto-researcher/blob/README_TRANSLATIONS/chinese%20(vereenvoudigd)_README.md)
[![](https://img.shields.io/badge/中文(传统)-_?style=voor-de-badge&logo=readme&color=white)](https://github.com/SergTyapkin/thaumcraft-auto-researcher/blob/README_TRANSLATIONS/chinese%20(traditioneel)_README.md)
[![](https://img.shields.io/badge/arabic(العربية)-_?style=voor-de-badge&logo=readme&color=white)](https://github.com/SergTyapkin/thaumcraf t-auto-researcher/blob/README_TRANSLATIONS/arabic_README.md)
...
[![](https://img.shields.io/badge/hindi(हिन्दी)-_?style=voor-de-badge&logo=readme&color=white)](https://github.com/SergTyapkin/thaumcraft-auto-researcher/blob/README_TRANSLATIONS/hindi_README.md)
[![](https://img.shields.io/badge/korean(한국어)-_?style=voor-de-badge&logo=readme&color=white)](https://github.com/SergTyapkin/thaumcraft-auto-researcher/blob/README_TRANSLATIONS/korean_README.md)

# Bekijk Thaumcraft 4 > _**Thaumcraft**_ - met deze _Minecraft_-functie kun je dit doen популярных серверах
## [Download .exe releases](https://github.com/SergTyapkin/thaumcraft-auto-researcher/releases)
[nieuwste versie `v1.1.3`](https://github.com/SergTyapkin/thaumcraft-auto-researcher/releases/tag/v1.1.3)
<details>
...
---
Het programma maakt gebruik van een neuraal netwerk en lost en rangschikt automatisch onderzoeksaantekeningen in de onderzoekstabel.
De gehele interactie-interface is doorschijnend en verschijnt bovenop alle vensters.

Het programma heeft **op geen enkele manier** interactie met de spelcode en wordt niet gedetecteerd door anti-cheats. 
Het enige wat het doet is kijken naar **pixels op het scherm**, en met behulp van een neuraal netwerk simuleert het **acties met een muis en toetsenbord**, alsof iemand het doet.

> [!BELANGRIJK]
> Voor vragen, fouten en suggesties, schrijf: [t.me/Tyapkin_S](https://t.me/tyapkin_s)

<details>
<summary>Lijst met ondersteunde add-ons (uitvouwen...)</summary>
...
0. Download het programma van [releases](https://github.com/SergTyapkin/thaumcraft-auto-onderzoeker/releases)
...
> [!TIP]
> Als een van de cellen verkeerd is gedefinieerd, kunt u op de cel klikken en selecteren welke cel het eigenlijk moet zijnA.
...
> [!TIP]
> - Om de onderzoeksaantekeningen één voor één te kunnen blijven onderzoeken, zoals ze in de inventaris staan, kunt u op `Ctrl+Enter` drukken en vervolgens
...
2. ***\[Optionele stap]*** UPX downloaden (verkleint de grootte van het uiteindelijke exe-bestand)
https://github.com/upx/upx/releases/


3. ZappenVoer de build-opdracht uit vanuit de projectroot (er wordt een interface geopend van waaruit u de build kunt uitvoeren):
```shell
...
---
### Speciale dank
- [Acak1221](https://github.com/acak1221) voor het creëren van het neurale netwerk dat het programma gebruikt