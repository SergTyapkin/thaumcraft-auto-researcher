...
The program using the neural network ** automatically solves and lays out ** research notes in the research table.
...
All she does is look at ** pixels on the screen **, and with the help of a neural network imitates ** actions with a mouse and keyboard **, as if a person did.
