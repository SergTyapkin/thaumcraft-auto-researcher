...
> _**Thaumcraft**_는 _Minecraft_ 게임용 모드로, 종종 인기 있는 서버의 매직 모드 어셈블리에 설치됩니다.
...
> [!중요]
> 질문, 오류 및 제안사항이 있는 경우 다음 주소로 메일을 보내주세요. [t.me/Tyapkin_S](https://t.me/tyapkin_s)

<details> <summary>지원되는 애드온 목록(확장...)</summary>
...
0. [releases](https://github.com/SergTyapkin/thaumcraft-auto-researcher/releases)에서 프로그램을 다운로드하세요.
1. 십자선이 움직일 수 있다는 시연 및 검증. 
빨간색 점을 노란색 점으로 옮기면 됩니다.
_MD_WDGT_41b954938아빠472391990e843a066793
...
프로그램이 게시할 측면 체인을 사용하여 솔루션이 자동으로 생성됩니다. ![image](https://github.com/SergTyapkin/thaumcraft-auto-researcher/blob/master/README_images/aspects_solved.png?raw=true)
...
> [!팁]
> 셀 중 하나라도 잘못 정의된 경우 해당 셀을 클릭하여 실제로 어떤 셀이 되어야 하는지 선택할 수 있습니다.
