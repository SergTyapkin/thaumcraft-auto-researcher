...
- Se agregó el modo de investigación continua.
...
> [!IMPORTANTE]
> Para cualquier duda, error y sugerencia escribir a: [t.me/Tyapkin_S](https://t.me/tyapkin_s)

<details> <summary>Lista de complementos compatibles (ampliar...)</summary>
...
0. Descargue el programa desde [releases](https://github.com/SergTyapkin/thaumcraft-auto-researcher/releases)
...
Se generará automáticamente una solución mediante cadenas de aspectos, que el programa irá publicando. ![image](https://github.com/SergTyapkin/thaumcraft-auto-researcher/blob/master/README_images/aspects_solved.png?raw=true)
...
- Traducción a otros idiomas en el interior. aplicaciones
