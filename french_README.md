...
## [téléchargement .exe versees] (https://github.com/sergtyapkin/thaumcraft-auto-rearch/releases)
...
Le programme utilisant le réseau neuronal ** résout et présente automatiquement les notes de recherche dans le tableau de recherche.
...
Tout ce qu'elle fait, c'est regarder ** pixels sur l'écran **, et avec l'aide d'un réseau neuronal imite ** des actions avec une souris et un clavier **, comme si une personne le faisait.
