...
[![](https://img.shields.io/badge/中文(简体)-_?style=for-the-badge&logo=readme&color=white)](https://github. com/SergTyapkin/thaumcraft-auto-researcher/blob/README_TRANSLATIONS/chinese%20(semplificato)_README.md)
[![](https://img.shields.io/badge/中文(传统)-_?style=for-the-badge&logo=readme&color=white)](https://github.com/SergTyapkin/thaumcraft-auto-researcher/blob/README_TRANSLATIONS/chinese%20(tradizionale)_README.md)
[![](https://img.shields.io/badge/arabic(العربية)-_?style=for-the-badge&logo=readme&color=white)](https://github.com/SergTyapkin/thaumcraf t-auto-researcher/blob/LEGGIMI_TRADUZIONI/arabic_LEGGIMI.md)
[![](https://img.shields.io/badge/español-_?style=for-the-badge&logo=readme&color=white)](https://github.com/SergTyapkin/thaumcraft-auto-researcher/blob/LEGGIMI_TRADUZIONI/spanish_LEGGIMI.md)
...
# Dispositivo automatico per Thaumcraft 4 > _**Thaumcraft**_ - modalità per i giochi di _Minecraft_, installata in modalità magica в на популярных серверах
## [Scarica le release .exe](https://github.com/SergTyapkin/thaumcraft-auto-researcher/releases)
[ultima versione `v1.1.3`](https://github.com/SergTyapkin/thaumcraft-auto-researcher/releases/tag/v1.1.3)
<details>
<summary>Log modifiche:</summary>
...
<details>
<summary>Elenco dei componenti aggiuntivi supportati (espandi...)</summary>
...
0. Scarica il programma da [versioni](https://github.com/SergTyapkin/thaumcraft-auto-researcher/releases)
...
> [!CONSIGLIO]
> Se una qualsiasi delle celle è definita in modo errato, puoi fare clic sulla cella e selezionare quale cella dovrebbe essere effettivamenteUN.
...
3. ZappaEsegui il comando build dalla root del progetto (si aprirà un'interfaccia da cui potrai eseguire la build):
```shell
