...
Il programma che utilizza la rete neurale ** risolve automaticamente e stabilisce ** Note di ricerca nella tabella di ricerca.
...
Tutto quello che fa è guardare ** pixel sullo schermo ** e con l'aiuto di una rete neurale imita ** azioni con un mouse e una tastiera **, come se una persona lo facesse.
