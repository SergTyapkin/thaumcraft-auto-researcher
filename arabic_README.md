...
# المستكشف التلقائي لـ Thaumcraft 4
...
- تم إضافة دعم لمختلف اللغات داخل البرنامج
...
> `v1.2._` - تكوين جميع الجوانب باستخدام العديد من الشبكات العصبية وصياغة الشبكات المفقودة
...
> _**Thaumcraft**_ هو نموذج للعبة _Minecraft_، غالبًا ما يتم تثبيته في مجموعات من التعديلات السحرية على الخوادم الشهيرة

يستخدم البرنامج شبكتين عصبيتين لتحديد الجوانب التي تظهر على الشاشة، **ويحل خوارزميًا ويرتب** الملاحظات البحثية في جدول البحث.
واجهة التفاعل بأكملها شفافة وتظهر أعلى نافذة اللعبة.

لا يتفاعل البرنامج **بأي شكل من الأشكال** مع رمز اللعبة ولا يتم اكتشافه بواسطة برامج مكافحة الغش.
كل ما يفعله هو النظر إلى **وحدات البكسل الموجودة على الشاشة**، واستخدام الشبكات العصبية لتحديد الجوانب التي تظهر على الشاشة، و**تقليد إجراءات الماوس ولوحة المفاتيح** كما لو كان الإنسان يقوم بذلك.
...
# كيفية استخدام هذا؟
> [!تنبيه]
> الصور والأوصاف لا تتطابق مع أحدث إصدار من البرنامج. ويستخدم نظام مماثل، ولكن أكثر تلقائية. يمكنك ببساطة اتباع التعليمات الموجودة داخل البرنامج وسيكون كل شيء واضحًا لك.
> سنقوم بالتأكيد بتحديث التعليمات أدناه، ولكن هذا كل ما في الأمر في الوقت الحالي.

### الإعداد المسبق
> _يتم تنفيذه مرة واحدة بعد أول تشغيل للبرنامج_
0. قم بتنزيل البرنامج من [الإصدارات](https://github.com/SergTyapkin/thaumcraft-auto-researcher/releases)
...
في المرة التالية التي تبدأ فيها تشغيل البرنامج، ليس من الضروري القيام بذلك؛ سيتم عرض الخطوة التالية على الفور.
...
> [!نصيحة]
> إذا تم تعريف أي من الخلايا بشكل غير صحيح، يمكنك النقر فوق الخلية وتحديد الشكل الذي يجب أن تكون عليه الخلية بالفعل.
...
3. قم بتشغيل أمر البناء من جذر المشروع (سيفتح واجهة يمكنك من خلالها تشغيل البناء):
```shell
...
- [Limuranius](https://github.com/Limuranius) لإنشاء شبكة عصبية لتحديد الجوانب وعددها في الجدول، والكثير من العمل على إنشاء نظام خفيف الوزن لإطلاق الشبكات العصبية