...
<details> <summary>Lijst met ondersteunde add-ons (uitvouwen...)</summary>
...
Er wordt automatisch een oplossing gegenereerd met behulp van ketens van aspecten, die het programma gaat posten ![image](https://github.com/SergTyapkin/thaumcraft-auto-researcher/blob/master/README_images/aspects_solved.png?raw=true)
...
- Vertaling naar andere talen binnen toepassingen
...
2. Voer het uit vanuit de hoofdmap van het project (vereist `Python 3.10` of hoger):
```shell
python ./src/main.py
```
