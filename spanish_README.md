...
El programa que utiliza la red neuronal ** resuelve y establece automáticamente ** notas de investigación en la tabla de investigación.
...
Todo lo que hace es mirar ** píxeles en la pantalla **, y con la ayuda de una red neuronal imita ** acciones con un mouse y teclado **, como si una persona lo hiciera.
