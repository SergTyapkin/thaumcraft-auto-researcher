...
[![](https://img.shields.io/badge/中文(传统)-_?style=for-the-badge&logo=readme&color=white)](https://github.com/SergTyapk en/thaumcraft-auto-researcher/blob/README_TRANSLATIONS/chino%20(tradicional)_README.md)
[![](https://img.shields.io/badge/arabic(العربية)-_?style=for-the-badge&logo=readme&color=white)](https://github.com/SergTyapkin/thaumcraf t-auto-researcher/blob/README_TRANSLATIONS/README_arabic.md)
...
3. zapatearEjecute el comando de compilación desde la raíz del proyecto (se abrirá una interfaz desde la cual puede ejecutar la compilación):
```shell
