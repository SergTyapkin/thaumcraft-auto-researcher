...
# थाउमक्राफ्ट 4 के लिए स्वचालित एक्सप्लोरर
...
- कार्यक्रम के भीतर विभिन्न भाषाओं के लिए समर्थन जोड़ा गया
...
> `v1.2._` - कई तंत्रिका नेटवर्क का उपयोग करके सभी पहलुओं का विन्यास और लापता लोगों को तैयार करना
...
> _**थॉमक्राफ्ट**_ गेम _माइनक्राफ्ट_ के लिए एक मॉड है, जिसे अक्सर लोकप्रिय सर्वर पर मैजिक मॉड असेंबली में इंस्टॉल किया जाता है

प्रोग्राम, स्क्रीन पर पहलुओं को निर्धारित करने के लिए दो तंत्रिका नेटवर्क का उपयोग करते हुए, शोध तालिका में शोध नोट्स को **एल्गोरिदमिक रूप से हल और व्यवस्थित** करता है।
संपूर्ण इंटरैक्शन इंटरफ़ेस पारभासी है और गेम विंडो के शीर्ष पर दिखाई देता है।

प्रोग्राम किसी भी तरह से गेम कोड के साथ इंटरैक्ट नहीं करता है और एंटी-चीट्स द्वारा इसका पता नहीं लगाया जाता है।
यह बस स्क्रीन पर **पिक्सेल** को देखता है, स्क्रीन पर कौन से पहलू हैं यह निर्धारित करने के लिए तंत्रिका नेटवर्क का उपयोग करता है, और **माउस और कीबोर्ड क्रियाओं की नकल करता है** जैसे कि कोई इंसान ऐसा कर रहा हो।
...
> [!सावधानी]
> चित्र और विवरण कार्यक्रम के नवीनतम संस्करण से मेल नहीं खाते। यह एक समान प्रणाली का उपयोग करता है, लेकिन अधिक स्वचालित है। आप बस प्रोग्राम के अंदर दिए गए संकेतों का पालन कर सकते हैं और आपके लिए सब कुछ स्पष्ट हो जाएगा।
> हम निश्चित रूप से नीचे दिए गए निर्देशों को अपडेट करेंगे, लेकिन अभी इतना ही।

### प्रीसेट
> _कार्यक्रम की पहली शुरुआत के बाद एक बार निष्पादित_
0. प्रोग्राम को [रिलीज़](https://github.com/SergTyapkin/thaumcraft-auto-researcher/releases) से डाउनलोड करें
...
अगली बार जब आप प्रोग्राम प्रारंभ करें तो ऐसा करना आवश्यक नहीं है; अगला चरण तुरंत दिखाया जाएगा.
...
> [!टिप]
> यदि किसी भी सेल को गलत तरीके से परिभाषित किया गया है, तो आप सेल पर क्लिक कर सकते हैं और चुन सकते हैं कि सेल वास्तव में क्या होना चाहिए।
...
3. प्रोजेक्ट रूट से बिल्ड कमांड चलाएँ (एक इंटरफ़ेस खुलेगा जिससे आप बिल्ड चला सकते हैं):
```shell
...
### विशेष धन्यवाद
- [Acak1221](https://github.com/acak1221) किसी समाधान में पहलुओं को निर्धारित करने के लिए एक तंत्रिका नेटवर्क बनाने के लिए
- [लिमुरानियस](https://github.com/Limuranius) तालिका में पहलुओं और उनकी संख्या निर्धारित करने के लिए एक तंत्रिका नेटवर्क बनाने के लिए, और तंत्रिका नेटवर्क लॉन्च करने के लिए एक हल्के सिस्टम बनाने पर बहुत काम किया गया है