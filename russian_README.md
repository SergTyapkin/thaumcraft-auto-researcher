...
- Добавлена поддержка различных языков внутри программы
...
Весь интерфейс взаимодействия полупрозрачный и показывается поверх окна игры.
...
- Жадность
- ГрегТех
- ГрегТех Новые Горизонты
- Таумические сапоги
- Ботанические аддоны
- Элизиум
- Таумические откровения
- Основная волшебство
- Интеграция AbyssalCraft
</details>
