...
## [Загрузить релизы .exe](https://github.com/SergTyapkin/thaumcraft-auto-researcher/releases)
[последняя версия `v1.1.3`](https://github.com/SergTyapkin/thaumcraft-auto-researcher/releases/tag/v1.1.3)
<details>
