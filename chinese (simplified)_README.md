...
# Автоматический исследователь для Thaumcraft 4 > _**Thaumcraft**_ - мод для игры _Minecraft_, часто устанавливающийся в магические сборки модов на популярных серверах ## [下载 .exe 版本](https://github.com/SergTyapkin/thaumcraft-auto-researcher/releases) [最新版本 `v1.1.3`](https://github.com/SergTyapkin/thaumcraft-auto-researcher/releases/tag/v1.1.3)
<details>
...
> `v1.1._` - 通过神经网络在表上配置方面，并且能够由用户更改
>
> `v1.0._` - 用户在表上配置方面
>
> `v0._._` - 预发布 MVP 版本
