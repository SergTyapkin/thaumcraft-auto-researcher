...
[![](https://img.shields.io/badge/中文(传统)-_?style=for-the-badge&logo=readme&color=white)](https://github.com/SergTyapk在/thaumcraft-auto-researcher/blob/README_TRANSLATIONS/chinese%20(traditional)_README.md)
...
## [下载 .exe 版本](https://github.com/SergTyapkin/thaumcraft-auto-researcher/releases)
...
### 预设 
> _程序第一次启动后执行一次_
0. 从[releases](https://github.com/SergTyapk)下载程序在/thaumcraft-auto-researcher/releases）
1. 十字准线可移动的演示与验证。 
只需将红点移动到黄点即可。
...
> [!提示]
> 如果任何单元格定义不正确，您可以单击该单元格并选择它实际上应该是哪个单元格一个。
之后，解决方案将自动重新生成
...
3. 电击从项目根目录运行构建命令（将打开一个可以运行构建的界面）：
```shell
